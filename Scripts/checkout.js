...
// this is called default export, we can use it when we only want to expost "one" thing form a file, and each file can only have one default export
// so the export with brackets are called -> "named export"
...
document.querySelector(".js-order-summary")
    .addEventListener ("change", (event) => {
        ...
        // After updating the data, re-render the entire order summary
        renderOrderSummary();
    });